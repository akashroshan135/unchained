...
urlpatterns = [
    ...
    #path('forum/viewthread-<id>/new', views.thread_posts_new, name='thread-posts-new'),        #the 'thread_posts_new' function in the views.py is called when localhost url path is followed by 'forum/viewthread-<id>/new'. <id> of the thread is recieved from html links. Needs implementation
